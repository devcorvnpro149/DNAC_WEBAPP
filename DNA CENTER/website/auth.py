...
url5 = "https://sandboxdnac.cisco.com/dna/intent/api/v1/network-device"
...
@auth.route('/health')
def health():
   return render_template('health.html', embed1 = data_json1)
...
@auth.route('/device')
def device():
   return render_template('device.html', embed5 = data_json5)
